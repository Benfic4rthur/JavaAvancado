...
import javax.swing.JTextField;
		...
		GridBagConstraints gridBagConstraints = new GridBagConstraints();//para utilizar o GridBagConstraints é necessário inicia-lo como um objeto
		gridBagConstraints.gridx = 0; // responsavel pelas linhas o valor após o igual é responsavel pela posição onde deve iniciar
		...
		descricaoHora.setPreferredSize(new Dimension(200, 25)); //seta as dimensões do label responsavel pela descrição da thread 1
		...
		descricaoHora2.setPreferredSize(new Dimension(200, 25)); //seta as dimensões do label2 responsavel pela descrição da thread 2
		...
		add(jpanel, BorderLayout.WEST);//aqui adiciona o painel no dialog orientando ele a esquerda com o borderLayout.WEST
		setVisible(true);// sempre sera o ultimo comando do construtor a ser executavel, ele é quem faz a tela ser visivel verdadeiro ou falso
	}
}